...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.62\textwidth]{Oscilador1.jpeg}
        \caption{Visualización de la señal alterna en el osciloscopio.}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.62\textwidth]{DesfaseSeñales.jpeg}
        \caption{Visualización de las señales desfasadas en el osciloscopio.}
